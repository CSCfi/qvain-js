		...
		<b-container>
			<b-row>
				<b-col>
					...
					<br />{{ commitHash }} - {{ version }}<br />
					<a target="_blank" href="http://digitalpreservation.fi/tietosuojaseloste">Privacy Policy</a> - <a target="_blank" href="https://www.fairdata.fi/hyodyntaminen/kayttopolitiikat-ja-ehdot/">Terms of Usage</a>
				</b-col>
				<b-col>
